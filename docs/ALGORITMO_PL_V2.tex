...
\begin{tikzpicture}[node distance=2cm, auto]
    \node[draw, rectangle, rounded corners, fill=blue!20, minimum width=3cm, minimum height=1cm] (f1) {Fase 1: Deteccao de Modo};
    \node[draw, rectangle, rounded corners, fill=green!20, minimum width=3cm, minimum height=1cm, right=of f1] (f2) {Fase 2: Calculo Backward};
    \node[draw, rectangle, rounded corners, fill=orange!20, minimum width=3cm, minimum height=1cm, right=of f2] (f3) {Fase 3: Otimizacao PL};
    \node[draw, rectangle, rounded corners, fill=red!20, minimum width=3cm, minimum height=1cm, right=of f3] (f4) {Fase 4: Execucao};
