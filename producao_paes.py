...
class TesteSistemaProducao:
    ...
    def configurar_log(self):
        ...
        self.log_filename = f'logs/execucao_pedidos_{modo}_{timestamp}.log'
    ...
    def executar_pedidos_ordenados(self):
        ...
        """
        print("🔄 Executando pedidos da padaria em ordem sequencial...")
    ...
    def executar_teste_completo(self):
        ...
        try:
            ...
            print(f"🥖 INICIANDO SISTEMA DE PRODUÇÃO DA PADARIA - MODO {modo}")
            print()
