...
class PreparoParaArmazenamentoDeCremeDeFrango(Atividade):
    ...
    def tentar_alocar_e_iniciar(
        ...
        inicio_jornada,
        fim_jornada,
        porcoes_bancada: int = 3  # 🔥 Número de porções padrão na bancada
    ):
        """
        ...
        # 🔹 Alocação da balança (ocupação exclusiva)
    ...
    def iniciar(self):
        ...
        print(f"🚀 Atividade {self.id} ({self.descricao}) iniciada às {self.inicio_real.strftime('%H:%M')}.")
