...
logger = setup_logger('Atividade_Preparo_Armazenamento_Creme_De_Frango')


class PreparoParaArmazenamentoDeCremeDeFrango(Atividade):
    """
    🥣 Atividade de preparo para armazenamento do creme de frango.
    ✔️ Equipamentos:
    ...
    def calcular_duracao(self):
        ...
        if 3000 <= q <= 20000:
            ...
            raise ValueError(f"❌ Quantidade {q} inválida para PreparoParaArmazenamentoDeCremeDeFrango.")
    ...
    def tentar_alocar_e_iniciar(
        ...
        # 🧪 Verifica se ao menos uma balança aceita o peso
        ...
        while horario_final_tentativa - self.duracao >= inicio_jornada:
            ...
            if not sucesso_balanca:
                ...
                logger.warning(
                    ...
                    f"Liberando bancada {bancada.nome} e encerrando tentativa."
                )
                return False
