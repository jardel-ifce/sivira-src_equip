...
logger = setup_logger('AtividadeArmazenamentoMassaDeBoloChocolate')


class ArmazenamentoSobTemperaturaParaMassaDeBoloDeChocolate(Atividade):
    """
    🍫 Atividade de armazenamento da massa de bolo de chocolate em câmara refrigerada a 4°C.
