...
class PreparoParaArmazenamentoDeCremeChantilly(Atividade):
    """
    🥛 Atividade de preparo para armazenamento do creme chantilly.
    ✔️ Equipamentos:
    ...
    def calcular_duracao(self):
        ...
        if 3000 <= q <= 10000:
            ...
            raise ValueError(
                f"❌ Quantidade {q}g inválida para PreparoParaArmazenamentoDeCremeChantilly."
            )

        logger.info(f"🕒 Duração calculada: {self.duracao} para {q}g de creme chantilly.")
