...
class PreparoParaArmazenamentoDeCarneDeSolRefogada(Atividade):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fim_bancada_real = None  # ✅ Rastreia fim real da bancada
    ...
    def calcular_duracao(self):
        ...
        if 3000 <= q <= 10000:
            ...
            raise ValueError(
                f"❌ Quantidade {q}g inválida para PreparoParaArmazenamentoDeCarneDeSolRefogada."
            )

        logger.info(f"🕒 Duração calculada: {self.duracao} para {q}g de carne de sol refogada.")
