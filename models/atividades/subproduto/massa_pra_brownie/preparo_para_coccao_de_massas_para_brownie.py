...
class PreparoParaCoccaoDeMassasParaBrownie(Atividade):
    """
    Atividade que representa o preparo para cocção de massas para brownie.
    Utiliza uma bancada (ocupando sua fração) e um armário esqueleto (1000g = 1 nível de tela).
    """
    ...
    def calcular_duracao(self):
        ...
        if 3000 <= q <= 6000:
            ...
            raise ValueError(
                f"❌ Quantidade {q} fora das faixas para PREPARO PARA COCCÃO DE MASSAS PARA BROWNIE."
            )
    ...
    def iniciar(self):
        ...
        for equipamento in equipamentos_ordenados:
            if isinstance(equipamento, Bancada) and bancada_alocada is None:
                ...
                if sucesso:
                    ...
                    print(
                        ...
                        f"para preparo da massa de brownie."
                    )
                else:
                    print(
            ...
            if bancada_alocada and armario_alocado:
                print(
                    f"✅ Preparo para cocção de massa de brownie iniciado com "
