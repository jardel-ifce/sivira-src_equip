...
class MisturaDeMassasParaBoloBranco(Atividade):
    """
    Atividade que representa a mistura de massas para bolo branco.
    ...
    def calcular_duracao(self):
        ...
        if 3000 <= q <= 6000:
            ...
            raise ValueError(
                f"❌ Quantidade {q} fora das faixas definidas para MISTURA DE MASSAS PARA BOLO BRANCO."
            )
    ...
    def iniciar(self):
        ...
        for equipamento in equipamentos_ordenados:
            if isinstance(equipamento, (BatedeiraPlanetaria, BatedeiraIndustrial)):
                ...
                if sucesso:
                    ...
                    print(
                        f"✅ Mistura de massas para bolo branco iniciada na batedeira {equipamento.nome} "
        ...
        raise Exception(
            "❌ Nenhuma batedeira disponível para a mistura de massas para bolo branco."
        )
