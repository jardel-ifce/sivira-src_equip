...
# 🧁 Logger específico
logger = setup_logger('Atividade_Preparo_Coccao_de_Massa_para_Bolo_Branco')


class PreparoParaCoccaoDeMassaParaBoloBranco(Atividade):
    """
    🧁 Atividade de preparo para coccão de massas para bolo branco.
    ✔️ Equipamentos:
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.niveis_ocupados = None  # Quantidade de níveis ocupados no armário
        self.armario_alocado = None
        self.bancada_alocada = None
        self.fim_bancada_real = None  # ✅ Novo campo para rastrear fim real da bancada
    ...
    def _registrar_sucesso(self, bancada, armario, inicio_bancada, fim_bancada, fim_armario):
        ...
        self.fim_bancada_real = fim_bancada  # ✅ Registrando o fim real da bancada
