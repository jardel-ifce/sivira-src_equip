...
from services.otimizacao.equipamentos.analisador_dependencias import AnalisadorDependencias
from services.otimizacao.equipamentos.agrupador_subprodutos import AgrupadorSubprodutos
