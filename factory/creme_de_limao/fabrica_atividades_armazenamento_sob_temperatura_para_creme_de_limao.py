# fabrica_atividades_armazenamento_sob_temperatura_para_creme_de_limao.py
...
from models.atividades.subproduto.creme_de_limao.armazenamento_sob_temperatura_para_creme_de_limao import (
    ArmazenamentoSobTemperaturaParaCremeDeLimao,
)
...
# ============================================
logger = setup_logger(
    "SimulacaoArmazenamentoCremeDeLimao",
    arquivo="logs/simulacao_armazenamento_creme_de_limao.log"
)
...
for i, quantidade in enumerate(quantidades):
    atividade = ArmazenamentoSobTemperaturaParaCremeDeLimao(
        id=i + 1,
        tipo_atividade=TipoAtividade.ARMAZENAMENTO_SOB_TEMPERATURA_PARA_CREME_DE_LIMAO,
