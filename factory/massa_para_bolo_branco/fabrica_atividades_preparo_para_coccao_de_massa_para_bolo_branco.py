...
from models.atividades.subproduto.massa_para_bolo_branco.preparo_para_coccao_de_massa_para_bolo_branco import (
    PreparoParaCoccaoDeMassaParaBoloBranco,
)
...
# ============================================
logger = setup_logger(
    "SimulacaoPreparoCoccaoMassasBoloBranco",
    arquivo="logs/simulacao_preparo_coccao_massas_bolo_branco.log"
)
...
for i, quantidade in enumerate(quantidades):
    atividade = PreparoParaCoccaoDeMassaParaBoloBranco(
        id=i + 1,
        tipo_atividade=TipoAtividade.PREPARO_PARA_COCCAO_DE_MASSAS_PARA_BOLO_BRANCO,
