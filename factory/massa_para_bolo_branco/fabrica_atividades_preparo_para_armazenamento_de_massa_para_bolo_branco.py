...
from models.atividades.subproduto.massa_para_bolo_branco.preparo_para_armazenamento_de_massa_para_bolo_branco import (
    PreparoParaArmazenamentoDeMassaParaBoloBranco,
)
...
# ============================================
logger = setup_logger(
    "SimulacaoPreparoArmazenamentoMassaBoloBranco",
    arquivo="logs/simulacao_preparo_armazenamento_massa_bolo_branco.log"
)
...
for i, quantidade in enumerate(quantidades):
    atividade = PreparoParaArmazenamentoDeMassaParaBoloBranco(
        id=i + 1,
        tipo_atividade=TipoAtividade.PREPARO_PARA_ARMAZENAMENTO_DE_MASSA_PARA_BOLO_BRANCO,
