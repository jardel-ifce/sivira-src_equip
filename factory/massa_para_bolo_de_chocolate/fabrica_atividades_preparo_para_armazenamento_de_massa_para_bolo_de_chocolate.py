# fabrica_atividades_preparo_para_armazenamento_de_massas_para_bolo_de_chocolate.py
...
from models.atividades.subproduto.massa_para_bolo_de_chocolate.preparo_para_armazenamento_de_massa_para_bolo_de_chocolate import (
    PreparoParaArmazenamentoDeMassaParaBoloDeChocolate,
)
...
# ============================================
logger = setup_logger(
    "SimulacaoPreparoArmazenamentoMassasBoloDeChocolate",
    arquivo="logs/simulacao_preparo_armazenamento_massas_bolo_de_chocolate.log"
)
...
for i, quantidade in enumerate(quantidades):
    atividade = PreparoParaArmazenamentoDeMassaParaBoloDeChocolate(
        id=i + 1,
        tipo_atividade=TipoAtividade.PREPARO_PARA_ARMAZENAMENTO_DE_MASSA_PARA_BOLO_DE_CHOCOLATE,
...
logger.info(f"🛠️ {len(atividades)} atividades de preparo para armazenamento das massas de bolo de chocolate criadas.")
