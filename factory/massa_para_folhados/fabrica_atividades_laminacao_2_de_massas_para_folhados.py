...
from models.atividades.subproduto.massa_para_folhados.laminacao_2_de_massas_para_folhados import (
    Laminacao2DeMassasParaFolhados,
)
...
for i, quantidade in enumerate(quantidades):
    atividade = Laminacao2DeMassasParaFolhados(
        id=i + 1,
        tipo_atividade=TipoAtividade.LAMINACAO_2_DE_MASSAS_PARA_FOLHADOS,
