# fabrica_atividades_armazenamento_sob_temperatura_para_creme_de_frango.py
...
from models.atividades.subproduto.creme_de_frango.armazenamento_sob_temperatura_para_creme_de_frango import (
    ArmazenamentoSobTemperaturaParaCremeDeFrango,
)
...
# ============================================
logger = setup_logger(
    "SimulacaoArmazenamentoCremeDeFrango",
    arquivo="logs/simulacao_armazenamento_creme_de_frango.log"
)
...
# ============================================
quantidades = [
    5000, 12000, 25000, 50000, 60000,
    7000, 9000, 11000, 15000, 20000,
    18000, 14000, 17000, 13000, 23000,
    10000, 8000, 16000, 21000, 22000,
    24000, 5000, 12000, 18000, 25000,
    7000, 9000, 11000, 15000, 20000
]
...
for i, quantidade in enumerate(quantidades):
    atividade = ArmazenamentoSobTemperaturaParaCremeDeFrango(
        id=i + 1,
        tipo_atividade=TipoAtividade.ARMAZENAMENTO_SOB_TEMPERATURA_PARA_CREME_DE_FRANGO,
