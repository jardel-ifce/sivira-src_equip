# fabrica_atividades_armazenamento_sob_temperatura_para_frango_refogado.py
...
from models.atividades.subproduto.frango_refogado.armazenamento_sob_temperatura_para_frango_refogado import (
    ArmazenamentoSobTemperaturaParaFrangoRefogado,
)
...
# ============================================
logger = setup_logger(
    "SimulacaoArmazenamentoFrangoRefogado",
    arquivo="logs/simulacao_armazenamento_frango_refogado.log"
)
...
# ============================================
quantidades = [
    5000, 12000, 25000, 50000, 60000, 7000, 9000, 11000, 15000, 20000,
    18000, 14000, 17000, 13000, 23000, 10000, 8000, 16000, 21000, 22000,
    24000, 5000, 12000, 18000, 25000, 7000, 9000, 11000, 15000, 20000
]
...
for i, quantidade in enumerate(quantidades):
    atividade = ArmazenamentoSobTemperaturaParaFrangoRefogado(
        id=i + 1,
        tipo_atividade=TipoAtividade.ARMAZENAMENTO_SOB_TEMPERATURA_PARA_FRANGO_REFOGADO,
