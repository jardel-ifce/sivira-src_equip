...
from models.atividades.subproduto.creme_de_queijo.preparo_para_coccao_de_creme_de_queijo import (
    PreparoParaCoccaoDeCremeDeQueijo,
)
...
# ============================================
logger = setup_logger(
    "SimulacaoPreparoCoccaoCremeDeQueijo",
    arquivo="logs/simulacao_preparo_coccao_creme_de_queijo.log"
)
...
for i, quantidade in enumerate(quantidades):
    atividade = PreparoParaCoccaoDeCremeDeQueijo(
        id=i + 1,
        tipo_atividade=TipoAtividade.PREPARO_PARA_COCCAO_DE_CREME_DE_QUEIJO,
...
logger.info(
    f"🛠️ {len(atividades)} atividades de preparo para cocção de creme de queijo criadas."
)
...
for atividade in atividades:
    ...
    sucesso = atividade.tentar_alocar_e_iniciar(
        ...
        fracoes_necessarias=1  # 🪵 Ocupa 1/6 da bancada
    )
