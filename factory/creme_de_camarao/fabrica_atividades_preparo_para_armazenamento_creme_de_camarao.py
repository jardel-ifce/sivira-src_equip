...
from models.atividades.subproduto.creme_de_camarao.preparo_para_armazenamento_de_creme_de_camarao import (
    PreparoParaArmazenamentoDeCremeDeCamarao,
)
...
# ============================================
logger = setup_logger(
    "SimulacaoPreparoArmazenamentoCremeDeCamarao",
    arquivo="logs/simulacao_preparo_armazenamento_creme_de_camarao.log"
)
...
gestor_balancas = GestorBalancas([balanca_digital_1, balanca_digital_2])
...
for i, quantidade in enumerate(quantidades):
    atividade = PreparoParaArmazenamentoDeCremeDeCamarao(
        id=i + 1,
        tipo_atividade=TipoAtividade.PREPARO_PARA_ARMAZENAMENTO_DE_CREME_DE_CAMARAO,
