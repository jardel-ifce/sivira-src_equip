...
from models.atividades.subproduto.creme_de_camarao.coccao_de_creme_de_camarao import (
    CoccaoDeCremeDeCamarao,
)
...
# ================================================
logger = setup_logger(
    "SimulacaoCoccaoCremeDeCamarao",
    arquivo="logs/simulacao_coccao_creme_de_camarao.log"
)
...
# ================================================
quantidades = [5000, 15000, 22000, 45000, 60000, 2000]
...
for i, quantidade in enumerate(quantidades):
    atividade = CoccaoDeCremeDeCamarao(
        id=i + 1,
        tipo_atividade=TipoAtividade.COCCAO_DE_CREME_DE_CAMARAO,
...
logger.info(f"🛠️ {len(atividades)} atividades de cocção de creme de camarão criadas.")
