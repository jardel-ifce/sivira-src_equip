...
from models.atividades.subproduto.creme_de_camarao.armazenamento_sob_temperatura_para_creme_de_camarao import (
    ArmazenamentoSobTemperaturaParaCremeDeCamarao,
)
...
# ============================================
logger = setup_logger(
    "SimulacaoArmazenamentoCremeDeCamarao",
    arquivo="logs/simulacao_armazenamento_creme_de_camarao.log"
)
...
# ============================================
quantidades = [
    5000, 12000, 18000, 25000,
    7000, 9000, 11000, 15000,
    20000, 18000, 14000, 17000,
    13000, 23000, 10000, 8000,
    16000, 21000, 22000, 24000,
    5000, 12000, 18000, 25000,
    7000, 9000, 11000, 15000,
    20000, 18000
]
...
for i, quantidade in enumerate(quantidades):
    atividade = ArmazenamentoSobTemperaturaParaCremeDeCamarao(
        id=i + 1,
        tipo_atividade=TipoAtividade.ARMAZENAMENTO_SOB_TEMPERATURA_PARA_CREME_DE_CAMARAO,
...
for atividade in atividades:
    ...
    sucesso = atividade.tentar_alocar_e_iniciar(
        ...
        temperatura_desejada=4  # 🌡️ Temperatura padrão
    )
